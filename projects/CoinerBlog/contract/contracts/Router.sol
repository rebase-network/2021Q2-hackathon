...
contract MesssageRouter is IRouter, AcceptedCaller {
    address public blogServiceAddr;
    ...
    function setBlogServiceAddr(address _blogServiceAddr)
        public
        onlyOwner
        returns (bool)
    {
        blogServiceAddr = _blogServiceAddr;
        return true;
    }
    ...
    function isAccepted() public view returns (bool) {
        ...
        if (blogService.isAcceptedCaller(address(this)) == false) {
            return false;
        }
