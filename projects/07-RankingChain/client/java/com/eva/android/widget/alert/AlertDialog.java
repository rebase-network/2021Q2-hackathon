 ...
 * {@link LayoutParams#FLAG_ALT_FOCUSABLE_IM
...
public class AlertDialog extends Dialog implements DialogInterface {
	...
	public void dismiss()
	{
	    //## Bug FIX: 20191208 by Jack Jiang
        //## 【解决什么问题？】解决本地用户个人信息中修改密码时，当表单数据检查未通过而不走默认的关闭对话框逻辑时，对话框的半透明背景消失的问题。
        //## 【如何解决的？】增加了"super.isShowing()"的判断，且将 执行代码提到super.dismiss()或super.cancel()前执行，防止此处代码未执行前就被父类方法设置。
        if(super.isShowing())
        //## Bug FIX: END
        {
...
//        }
	...
	private void initCoverLayer()
	{
		if(getContext() != null)
		{
			...
			View root = ((Activity)mAlert.getContext()).getWindow().getDecorView();
    ...
    {
       /* if (GlobalConstant.IS_DISMISS_DIALOG)
        {
            dismiss();
        }*/
