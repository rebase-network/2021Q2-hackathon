...
public class AlertController {
    ...
    private void setupView() {
    	...
    	/*TypedArray a = mContext.obtainStyledAttributes(
        null, R.styleable.AlertDialog, 0, R.style.AlertDialog);*/
        ...
        if (mView != null) {
            ...
            custom.addView(mView, new LayoutParams(FrameLayout.LayoutParams.FILL_PARENT, 
            ...
            if (hasTextTitle) {
               ...
               //mIconView.setImageResource(R.drawable.ic_dialog_menu_generic);
                ...
                if (mIconId > 0) {
                    ...
                    //@since 6.0 20191205 add by Jack Jiang，用于修正设置的icon不显示的问题
    ...
    private void setupContent(LinearLayout contentPanel) {
        ...
        if (mMessage != null) {
            ...
            if (mListView != null) {
                ...
                contentPanel.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.FILL_PARENT, 0, 1.0f));
            } else {
