...
//import com.tang.widget.CNiaoToolBar;
import com.tang.widget.ClearEditText;


//这个钱包相关的过程可以与登链比较一下看有没有需要改进的地方
...
//    private CNiaoToolBar mToolBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chain_activity_login);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                LoginActivity.this.finish();   //这个会跳转到startActivity中。
            }
        });
...
//    }
    ...
    public void progressBar_Login(View view) {    //登入时根据账号及密码获得钱包文件
        ProgressBar pgb=(ProgressBar)findViewById(R.id.progressbar);
