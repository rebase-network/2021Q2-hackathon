...
const notice = require('../components/notice.vue').default;
const store = require('../components/store.vue').default;
const deposit = require('../components/deposit.vue').default;
const exchange = require('../components/exchange.vue').default;

const combinationEit = require('../components/combinationEit.vue').default;
const backpack = require('../components/backpack.vue').default;
const cardInfo = require('../components/cardInfo.vue').default;
const updateSd = require('../components/updateSuccessed.vue').default;
const fusing = require('../components/fusing.vue').default;
const fusionEnd = require('../components/fusionEnd.vue').default;

const buyEnd = require('../components/buyEnd.vue').default;

const giveUp = require('../components/giveUp.vue').default;
const giveUpInfo = require('../components/giveUpInfo.vue').default;
const editEnd = require('../components/editEnd.vue').default;
...
module.exports = new VueRouter({
  routes: [
    ...
    { path: '/combinationEit', component: combinationEit },
    { path: '/backpack', component: backpack },
    { path: '/cardInfo', component: cardInfo },
    { path: '/updateSd', component: updateSd },
    { path: '/fusing', component: fusing },
    { path: '/fusionEnd', component: fusionEnd },
    { path: '/buyEnd', component: buyEnd },
    { path: '/giveUp', component: giveUp },
    { path: '/giveUpInfo', component: giveUpInfo },
    { path: '/editEnd', component: editEnd },
    {
      path: '/',
      redirect: '/home'
    }
