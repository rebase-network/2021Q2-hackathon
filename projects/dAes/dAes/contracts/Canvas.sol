...
contract Canvas is Context, ERC165, IERC721, IERC721ExMetadata, ICanvas{
    ...
    // Mapping all pixels in canvas
    mapping (uint256 => Pixel) private _canvas;
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC165, IERC165) returns (bool) {
        return interfaceId == type(IERC721).interfaceId
            || interfaceId == type(IERC721ExMetadata).interfaceId
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        _balances[to] += 1;
        _canvas[tokenId] = Pixel(255, 255, 255, 10);
        _owners[tokenId] = to;
    ...
    function _transfer(address from, address to, uint256 tokenId) internal virtual {
        require(Canvas.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(Canvas.ownerOf(tokenId), to, tokenId);
    }
    ...
    function _beforeTokenTransfer(address from, address to, uint256 tokenId) internal virtual { }
     ...
     function claim(address claimer, uint16 xAxis, uint16 yAxis)
    ...
    function _color(uint256 tokenId_, uint8 r_, uint8 g_, uint8 b_, uint8 a_) internal virtual {
        Pixel memory pixel = Pixel(r_, g_, b_, a_);
        require(_validPixel(pixel), "invalid rgba string");
